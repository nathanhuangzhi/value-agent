...
# --- Optional ---
ALPHAVANTAGE_API_KEY=...    # earnings-call transcripts for the AI chat (free key, 25 requests/day); without it the stage is skipped
